...
module.exports = async () => {
	const products = [
		...
		{
			name: "Deck Trap Stil Preut 8.125",
			description:
				"Las tablas TRAP son de las mejores opciones de calidad y precio que hay en el mercado, siempre de Maple Canadiense. Esta marca Alemana está representada en Uruguay desde al año 2015 y siempre fue de las opciones de preferencia de los skaters más exigentes",
			details: ["Material: 7 Capas De Maple Canadiense", "Lija Incluída: Si"],
			imageUrl:
				"https://f.fcdn.app/imgs/5046a4/www.tiendarepublica.com/rep/074f/webp/catalogo/DeckTrapStilPreut8.125DeckTrapStilPreut8.1251/460x460/deck-trap-stil-preut-8-125-solo-tabla-deck-trap-stil-preut-8-125-solo-tabla.jpg",
			price: 2690,
			stock: 101,
			featured: false,
			slug: "deck-trap-still-preut",
			categoryId: 1,
		},
		{
			name: "Tabla Skate Jart Renaissance",
			description:
				"Se trata de una tabla de skate de la marca profesional Jart Skateboards que dispone de unas dimensiones intermedias, fantásticas para quien busca una gran versatilidad de opciones patinando en múltiples modalidades que van desde trucos o street pasando por skatepark, rampa y bowl. Esta tabla Jart de 8.0 pulgadas es de cóncavo alto para ofrecer así una respuesta más rápida de movimientos.",
			details: [
				"Tamaño 8.0'' x 31.44''",
				"Wheelbase 14.25'' / Nose 6.6'' / Tail 6.3''.",
			],
			imageUrl:
				"https://cdn.skatespain.com/media/catalog/product/cache/1/image/1060x/602f0fa2c1f0d1ba5e241f914e856ff9/t/j/tja262-tabla-skate-jart-renaissance-ii-weedsuschrist-8.0.jpg",
			price: 2250,
			stock: 31,
			featured: true,
			slug: "tabla-jart-renaissance",
			categoryId: 1,
		},
		{
			name: "Tabla Sk8mafia Kremer Style",
			description:
				"Tabla Skate Sk8mafia Kremer Style 8.0 pulgadas. Se incluye la lija negra sin pegar de manera gratuita como regalo de nuestra tienda skate online.",
			details: [
				"Tamaño 8.0'' x 32''",
				"Wheelbase 14.25'' / Nose 6.6'' / Tail 6.3''.",
				"Cóncavo medio.",
			...
			imageUrl:
				"https://cdn.skatespain.com/media/catalog/product/cache/1/image/530x/602f0fa2c1f0d1ba5e241f914e856ff9/t/s/tsk8m026-tabla-skate-sk8mafia-kremer-style-8.0.jpeg",
			price: 2890,
			stock: 61,
			featured: true,
			slug: "tabla-sk8mafia-kremer-style",
			categoryId: 1,
		},
		{
			name: "Tabla Skate Toy Machine",
			description:
				"Composición premium de 7 láminas de madera de arce 100% canadiense con resina Epoxy.",
			details: [
				"Tamaño 8.0'' x 32''",
				"Wheelbase 14.25'' / Nose 6.9'' / Tail 6.7''.",
				"Cóncavo medio.",
			],
			imageUrl:
				"https://cdn.skatespain.com/media/catalog/product/cache/1/image/530x/602f0fa2c1f0d1ba5e241f914e856ff9/t/t/ttm009-tabla-skate-toy-machine-bury-the-hatchet_1.jpg",
			price: 3100,
			stock: 91,
			featured: false,
			slug: "tabla-toy-machine",
			categoryId: 1,
		},
		{
			name: "Tabla Jart Abstraction",
			description:
				"Composición estándar de 7 láminas de madera de arce 100% canadiense con 2XS. Fabricada mediante Single Deck Press",
			details: [
				"Tamaño 8.0'' x 32''",
				"Wheelbase 14.25'' / Nose 6.9'' / Tail 6.7''.",
				"Peso 1,33 kg.",
			...
			imageUrl:
				"https://cdn.skatespain.com/media/catalog/product/cache/1/image/530x/602f0fa2c1f0d1ba5e241f914e856ff9/t/j/tja302-tabla-skate-jart-abstraction-8.375.jpg",
			price: 2200,
			stock: 145,
			featured: false,
			slug: "tabla-jart-abstraction",
			categoryId: 1,
		},
		{
			name: "Tabla Skate Flip Rabelo Kaja 8.0",
			description:
				"Composición premium de 7 láminas de madera de arce 100% canadiense.",
			details: [
				"Tamaño 8.0'' x 31.5''",
				"Wheelbase 14.25'' / Nose 6.6'' / Tail 6.4''.",
				"Peso 1,20 kg.",
			],
			imageUrl:
				"https://cdn.skatespain.com/media/catalog/product/cache/1/image/1060x/602f0fa2c1f0d1ba5e241f914e856ff9/t/f/tflip051-tabla-skate-flip-rabelo-kaja-8.0.jpg",
			price: 3300,
			stock: 99,
			featured: true,
			slug: "tabla-flip-rabelo",
			categoryId: 1,
		},
		{
			name: "Tabla Skate Cruzade Face 8.375",
			description:
				"Composición premium de 7 láminas de madera de arce 100% canadiense. Por la compra de tu tabla Cruzade te regalamos la lija negra de marca Jessup por cortesía de nuestra tienda de skate online.",
			details: [
				"Tamaño 8.375'' x 32.36''",
				"Wheelbase 14.25'' / Nose 6.6'' / Tail 6.4''.",
				"Peso 1,30 kg.",
			],
			imageUrl:
				"https://cdn.skatespain.com/media/catalog/product/cache/1/image/1060x/602f0fa2c1f0d1ba5e241f914e856ff9/t/c/tcrz063-tabla-skate-cruzade-face-8.375.jpg",
			price: 2410,
			stock: 93,
			featured: false,
			slug: "tabla-cruzade-face",
			categoryId: 1,
		},
	];
